...
save_kable(Indices,here("Figures","4759_cases","Fit_Indices_Complete_Sample.png"))
...
Screeplot <- qplot(Title, values, data = results2, color = factor(criterias))+
  ...
  ggtitle("Scree Plot of Sample A (4759 cases)") 
ggsave(here("Figures","4759_cases","Scree_Plot_Complete_Sample.pdf"),Screeplot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
Loglikelihood <- qplot(Title, values, data = results2, color = factor(criterias))+
  ...
  theme(axis.text.x=element_text(size=14),axis.text.y=element_text(size=14),
        legend.title = element_text(size = 14, face="bold"),
        legend.text = element_text(size = 12))+
  ggtitle("Loglikelihood Plot of Sample A (4759 cases)") 
ggsave(here("Figures","4759_cases","Loglikelihood_Plot_Complete_Sample.pdf"),Loglikelihood,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","4759_cases","LCA_7class_Complete_Sample.pdf"),final_plot,width=30, height=22, dpi=300,units=c("cm"),limitsize = FALSE)
...
setwd(here("Data", "Processed_Data", "MPlus_data","MPlus_4759cases", "7_class_results"))
getwd()
