...
labels <- c(
  "1" = paste0("Low-risk yet heavy drinkers (", class_count[1, 3], ")"),
  "2" = paste0("Low-risk (", class_count[2, 3], ")"),
  "3" = paste0("High-risk smokers (", class_count[3, 3], ")"),
  "4" = paste0("High-risk heavy drinkers (", class_count[4, 3], ")"),
  "5" = paste0("Low-risk yet inactive (", class_count[5, 3], ")"),
  "6" = paste0("Inactive, low consumption (", class_count[6, 3], ")"),
...
model_results$LatentClass_factor <- factor(model_results$LatentClass, levels = c('2','1','5','6','4','3'))
...
Recoded_model_results$LatentClass_factor <- factor(model_results$LatentClass, levels = c('2','1','5','6','4','3'))
...
gg_no_legend <- Recoded_model_results %>%
  ...
  theme(text=element_text(size=14,  family = "Arial"),
        ...
        strip.text.x = element_text(size = 13.5,face = "bold",margin = margin(0.5,0,0.5,0, "cm")),
...
ggsave(here("Figures","4404_cases","LCA_6class_Complete_Sample.pdf"),final_plot,width=30, height=22, dpi=300,units=c("cm"),limitsize = FALSE)
...
setwd(here("Data", "Processed_Data", "MPlus_data","MPlus_4404cases", "Complete_sample_selected_model"))
getwd()
...
Wealth_2 NE -99 AND Wealth_3 NE -99;
  ...
  usevar =  Female Age
   Pat_Int Pat_Hig Self_Int Self_Hig Edu_Upp
   Edu_Ter Wealth_2 Wealth_3 NERVOU NERVOU_4;
  WEIGHT  = Weights;",
  ANALYSIS =
    "estimator = mlr;
  type = mixture;
...
NERVOU ON Female Age
   Pat_Int Pat_Hig Self_Int Self_Hig Edu_Upp
   Edu_Ter Wealth_2 Wealth_3 NERVOU_4;         ! covariate as predictor of distal
