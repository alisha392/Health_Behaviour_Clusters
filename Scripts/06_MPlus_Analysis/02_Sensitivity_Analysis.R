...
#write.csv(Sample_A,here("Data","Processed_Data","MPlus_data","MPlus_4759cases","Sensitivity_analysis","Sample_A.csv"))
#write.csv(Sample_B,here("Data","Processed_Data","MPlus_data","MPlus_4759cases","Sensitivity_analysis","Sample_B.csv"))

#
Sample_A <- read_csv(here("Data","Processed_Data","MPlus_data","MPlus_4759cases","Sensitivity_analysis","Sample_A.csv"))

Sample_A <- Sample_A %>% 
  dplyr::select(-1)

Sample_B <- read_csv(here("Data","Processed_Data","MPlus_data","MPlus_4759cases","Sensitivity_analysis","Sample_B.csv"))
...
setwd(here("Data", "Processed_Data", "MPlus_data","MPlus_4759cases","Sensitivity_analysis", "Class_enumeration_SampleA"))
getwd()
...
save_kable(Indices,here("Figures","4759_cases","Fit_Indices_Sample_A.png"))
...
ggsave(here("Figures","4759_cases","Scree_Plot_Sample_A.png"),Screeplot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","4759_cases","Loglikelihood_Plot_Sample_A.png"),Loglikelihood,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
final_plot
ggsave(here("Figures","4759_cases","LCA_5class_SampleA.png"),final_plot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","4759_cases","LCA_6class_SampleA.pdf"),final_plot,width=30, height=22, dpi=300,units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","4759_cases","LCA_7class_SampleA.png"),final_plot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)



#### SAMPLE B : Class enumeration #####
#setting to relative path as MPlus only accepts 90 characters in each line 
setwd(here("Data", "Processed_Data", "MPlus_data","MPlus_4759cases","Sensitivity_analysis", "Class_enumeration_SampleB"))
getwd()
lca_k1_6 <- lapply(1:9, function(k) {
  lca_enum <- mplusObject(
    TITLE = glue("C{k}_LCA_enumerate"),
...
save_kable(Indices,here("Figures","4759_cases","Fit_Indices_Sample_B.png"))
...
ggsave(here("Figures","4759_cases","Scree_Plot_Sample_B.png"),Screeplot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","4759_cases","Loglikelihood_Plot_Sample_B.png"),Loglikelihood,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
final_plot <- grid.arrange(gg_no_legend, legends, ncol = 2, widths = c(5, 1))
final_plot
ggsave(here("Figures","4759_cases","LCA_5class_SampleB.png"),final_plot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","4759_cases","LCA_6class_SampleB.png"),final_plot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","4759_cases","LCA_7class_SampleB.png"),final_plot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
#setting to relative path as MPlus only accepts 90 characters in each line 
setwd(here("Data", "Processed_Data", "MPlus_data","MPlus_4759cases","Complete_sample"))
getwd()
...
save_kable(enum_summary,here("Figures","4759_cases","Fit_Indices_Complete_Sample.png"))
Indices <- enum_summary %>%
  kable(booktabs = T, linesep = "") %>%
  kable_styling(c("striped"),
                full_width = F,
...
Indices <- save_kable(Indices,here("Figures","4759_cases","Fit_Indices_Complete_Sample.png"))
...
ggsave(here("Figures","4759_cases","Scree_Plot_Complete_Sample.png"),Screeplot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
#### Plotting the log likelihood of models with different number of classes
...
ggsave(here("Figures","4759_cases","Loglikelihood_Plot_Complete_Sample.png"),Loglikelihood,width=30, height=22, dpi=300, units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","4759_cases","LCA_5class_Complete_Sample.png"),final_plot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","4759_cases","LCA_6class_Complete_Sample.png"),final_plot,width=30, height=22, dpi=300,units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","4759_cases","LCA_7class_Complete_Sample.png"),final_plot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
